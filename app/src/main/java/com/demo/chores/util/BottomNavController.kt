...
import com.demo.chores.fragments.main.account.AccountNavHostFragment
import com.demo.chores.fragments.main.blog.BlogNavHostFragment
import com.demo.chores.fragments.main.create_blog.CreateBlogNavHostFragment
...
const val BOTTOM_NAV_BACKSTACK_KEY = "com.demo.chores.util.BottomNavController.bottom_nav_backstack"
...
class BottomNavController(
    ...
    class BackStack : ArrayList<Int>(), Parcelable {
        ...
        override fun removeLast() = removeAt(size - 1)
